...
public class Topic {
	...
	public String toString() {
		return "Topic [id=" + id + ", topicId=" + topicId + ", topicName=" + topicName + ", topicYear=" + topicYear
				+ ", demand=" + demand + ", numberLimit=" + numberLimit + ", numberNow=" + numberNow + ", majorLimit="
				+ majorLimit + ", deadline=" + deadline + ", releaseSingal=" + releaseSingal + ", userId=" + userId
				+ ", userName=" + userName + ", deadlineString=" + deadlineString + "]";
	}
